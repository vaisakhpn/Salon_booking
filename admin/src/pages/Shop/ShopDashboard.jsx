...
const Dashboard = () => {
  const { dashData, sToken, getDashData, loadingShops, cancelBooking } =
      ...
      {loadingShops ? (
        ...
        <div className="space-y-4">
          <div className="animate-pulse flex gap-4">
            <div className="bg-gray-200 h-20 w-52 rounded" />
            <div className="bg-gray-200 h-20 w-52 rounded" />
          </div>

          <div className="animate-pulse mt-10">
            <div className="bg-gray-200 h-10 w-1/3 mb-4 rounded" />
