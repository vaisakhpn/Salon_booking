      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            ...
            services faster, easier, and more convenient than ever before.
            Whether you are looking for a quick trim, a luxurious spa session,
            or last-minute grooming services, we help you find the perfect slot
            at a salon near you.
          </p>
